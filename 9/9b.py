class ReadingHistory:
    ...
    def interpolate_next_value(self):
        ...
        history_calculation_lines[-1].insert(0, 0)
        for line_index in reversed(range(len(history_calculation_lines) - 1)):
            history_calculation_lines[line_index].insert(0, history_calculation_lines[line_index][0] - history_calculation_lines[line_index + 1][0])
        return history_calculation_lines [0][0]
